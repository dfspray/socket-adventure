...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return ["How boring. White wallpaper.",
                "Gross. The wallpaper is green.",
                "The brown wallpaper makes this room look really old",
                "What color is this wallpaper? Mauve?",][room_number]
    ...
    def route(self):
        ...
        received = (self.input_buffer[:-1]).split(" ")
        print(received)
